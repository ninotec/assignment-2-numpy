...
def function5():
    ...
    z = np.zeros(20) .reshape(4,5)  #write your code here
...
def function6():
    ...
    arr =arr =np.zeros(20) #wrtie your code here
    arr[4]=10
    arr[7]=20 
...
def function15():
    ...
    ans = arr[np.argsort(arr[:,1])]  #write code here
...
def function17():
    ...
    ans= np.where((arr % 3==0) & (arr % 5==0), "YES", "NO" ) # Write Your Code HERE
    return ans         
#Excpected Out
"""
...
def function18():
    ...
    x = np.intersect1d(piaic,students).size # Write Your Code HERE
    return x
